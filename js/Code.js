...
function clues() {
    ...
    fill("lightblue")
    text("Hint: Always changing, not constant !! (ALL CAPS)", 100,70)

    fill("white")
    textSize(15)
    text("C U T N I F O N", 700,150)
    fill("lightblue")
    text("Hint: Performs a particular task !! (ALL CAPS)", 700,170)

    fill("white")
    textSize(15)
    text("A T E D A S B A", 100,250)
    fill("lightblue")
    text("Hint: Stores all information !! (ALL CAPS)", 100,270)
